...
# ./build/bin/sender_cli -d db-1M.csv -p parameters/1M-5535-PoL.json -l debug -t 1
#./build/bin/sender_cli -d db-1M.csv -p parameters/1M-11041-PoL.json -l debug -t 1
# ./build/bin/sender_cli -d db-16M.csv -p parameters/16M-5535-PoL.json -l debug -t 1
# ./build/bin/sender_cli -d db-16M.csv -p parameters/16M-11041-PoL.json -l debug -t 1
