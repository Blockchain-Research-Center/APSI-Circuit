...
subprocess.run("python3 ./tools/scripts/test_data_creator.py 1048576 5535 20 0 64", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
subprocess.run("python3 ./tools/scripts/test_data_creator.py 16777216 5535 20 0 64", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
subprocess.run("python3 ./tools/scripts/test_data_creator.py 268435456 5535 20 0 64", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)

subprocess.run("sed -i 's/auto numOfslice = 3/auto numOfslice = 5/g' sender/apsi/sender_db.cpp", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
...
subprocess.run("sed -i 's/auto numOfslice = 3/auto numOfslice = 6/g' sender/apsi/sender_db.cpp", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
...
subprocess.run("sed -i 's/auto numOfslice = 5/auto numOfslice = 3/g' sender/apsi/sender_db.cpp", shell=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
